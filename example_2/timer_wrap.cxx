...
static SwigV8ReturnValue _wrap_new_Timer(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  
  SWIGV8_OBJECT self = args.Holder();
  Timer *result;
  if(self->InternalFieldCount() < 1) SWIG_exception_fail(SWIG_ERROR, "Illegal call of constructor _wrap_new_Timer.");
  if(args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_new_Timer.");
  result = (Timer *)new Timer();
  
  
  
  SWIGV8_SetPrivateData(self, result, SWIGTYPE_p_Timer, SWIG_POINTER_OWN);
  SWIGV8_RETURN(self);
...
static void _wrap_delete_Timer(const v8::WeakCallbackInfo<SWIGV8_Proxy> &data) {
  ...
  if(proxy->swigCMemOwn && proxy->swigCObject) {
    Timer * arg1 = (Timer *)proxy->swigCObject;
    delete arg1;
  }
  delete proxy;
}
...
static SwigV8ReturnValue _wrap_Timer_startTimer(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Timer_startTimer.");
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Timer_startTimer" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);(arg1)->startTimer(arg2);
...
static SwigV8ReturnValue _wrap_Timer_stopTimer(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 0 || args.Length() > 0) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Timer_stopTimer.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_Timer, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Timer_stopTimer" "', argument " "1"" of type '" "Timer *""'"); 
  }
  arg1 = reinterpret_cast< Timer * >(argp1);(arg1)->stopTimer();
  jsresult = SWIGV8_UNDEFINED();
...
static SwigV8ReturnValue _wrap_Timer_onTimeout(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if (args.Length() < 1 || args.Length() > 1) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Timer_onTimeout.");
  
  res1 = SWIG_ConvertPtr(args.Holder(), &argp1,SWIGTYPE_p_Timer, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Timer_onTimeout" "', argument " "1"" of type '" "Timer *""'"); 
  }
  arg1 = reinterpret_cast< Timer * >(argp1);ecode2 = SWIG_AsVal_float(args[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Timer_onTimeout" "', argument " "2"" of type '" "float""'");
  } 
  arg2 = static_cast< float >(val2);(arg1)->onTimeout(arg2);
  jsresult = SWIGV8_UNDEFINED();
...
#endif
{
  ...
  /* Name: _exports_Timer, Type: p_Timer, Dtor: _wrap_delete_Timer */
SWIGV8_FUNCTION_TEMPLATE _exports_Timer_class = SWIGV8_CreateClassTemplate("_exports_Timer");
SWIGV8_SET_CLASS_TEMPL(_exports_Timer_clientData.class_templ, _exports_Timer_class);
_exports_Timer_clientData.dtor = _wrap_delete_Timer;
if (SWIGTYPE_p_Timer->clientdata == 0) {
  SWIGTYPE_p_Timer->clientdata = &_exports_Timer_clientData;
}


  /* register wrapper functions */
  SWIGV8_AddMemberFunction(_exports_Timer_class, "startTimer", _wrap_Timer_startTimer);
SWIGV8_AddMemberFunction(_exports_Timer_class, "stopTimer", _wrap_Timer_stopTimer);
SWIGV8_AddMemberFunction(_exports_Timer_class, "onTimeout", _wrap_Timer_onTimeout);
  ...
  /* class instances */
  /* Class: Timer (_exports_Timer) */
SWIGV8_FUNCTION_TEMPLATE _exports_Timer_class_0 = SWIGV8_CreateClassTemplate("Timer");
_exports_Timer_class_0->SetCallHandler(_wrap_new_Timer);
_exports_Timer_class_0->Inherit(_exports_Timer_class);
#if (SWIG_V8_VERSION < 0x0704)
_exports_Timer_class_0->SetHiddenPrototype(true);
v8::Local<v8::Object> _exports_Timer_obj = _exports_Timer_class_0->GetFunction();
#else
v8::Local<v8::Object> _exports_Timer_obj = _exports_Timer_class_0->GetFunction(context).ToLocalChecked();
#endif
  ...
  /* register classes */
  SWIGV8_MAYBE_CHECK(exports_obj->Set(context, SWIGV8_SYMBOL_NEW("Timer"), _exports_Timer_obj));
